...
*Source: outputs/report.md. Anchored in 191 atomic claims across 10 languages.*

## Slide 1 — Title

Programming Languages in the AI Era — a greenfield evaluation of 10 languages against the demands of AI-assisted and AI-agentic software development. Framework v0.1, snapshot 2026-04-30. Author: Rutger Hemrika.
...
- **Elixir (3.40)** — default for fault-tolerant distributed systems. BEAM concurrency and OTP supervision [elixir-001, elixir-002] over the verification gap [elixir-005]; Phoenix LiveView [elixir-009] is a credible substrate for real-time AI-augmented UIs.
...
| Data / AI/ML / scripting | Python (typed, day-one) | TypeScript for data products |
